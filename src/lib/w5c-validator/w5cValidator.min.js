  ...
  angular.module("w5c.validator").directive("w5cFormValidate", ["$parse", "w5cValidator", "$timeout", function (a, b, c) {
    return {
      require: ["w5cFormValidate", "^?form"], controller: ["$scope", function (a) {
        this.needBindKeydown = !1, this.form = null, this.formElement = null, this.submitSuccessFn = null, this.validElements = [], this.init = function (a, b) {
          ...
          this.form.$errors = [], b.removeError(a, this.options)
          ...
          for (var a = [], c = 0; c < j.length; c++) {
            ...
            if (e && h.validElements.indexOf(e) >= 0) {
              ...
              if (i[e] && f && b.elemTypes.toString().indexOf(f.type) > -1 && !b.isEmpty(f.name)) {
                ...
                a.push(g[0]), b.removeError(f, l), b.showError(f, g, l)
              }
            }
          }
          i.$errors = !b.isEmpty(a) && a.length > 0 ? a : [], d.$$phase || d.$apply(i.$errors)
        };
        i && (i.doValidate = o, i.reset = function () {
          c(function () {
            i.$setPristine();
            for (var a = 0; a < j.length; a++) {
              var c = j[a], d = angular.element(c);
              b.removeError(d, l)
            }
          })
    ...
    "use strict";
    return {
      require: ["ngModel", "^w5cFormValidate"], link: function (a, b, c, d) {
        var e = b.inheritedData("$formController")[c.w5cRepeat], f = d[0], g = d[1];
        f.$parsers.push(function (a) {
          return a === e.$viewValue ? f.$setValidity("repeat", !0) : f.$setValidity("repeat", !1), a
        }), e.$parsers.push(function (a) {
          return f.$setValidity("repeat", a === f.$viewValue), a === f.$viewValue && g.removeError(b), a
        })
      }
    }
  }]).directive("w5cCustomizer", ["$timeout", function () {
    "use strict";
    return {
        ...
        var g = f[0], h = f[1], i = f[2], j = function () {
          ...
          b.get(j).success(function (a) {
            ...
            if (g.$setValidity("w5cuniquecheck", b), !b) {
              ...
              c.showError(d[0], [e], h.options), i.$errors ? i.$errors.unshift(e) : i.$errors = [e]
            }
          })
        };
